  ...
  journey: JourneyItem[] = [
    {
      ...
      countryEmoji: '🇫🇷',
      highlights: [
        'Specializing in Prompt Engineering across GPT models, Claude, Mistral, Gemini, and generative image AI.',
        'Training teams in Prompt Engineering, AI & Legal, AI Security, AI Ethics, and generative image AI content creation.',
        'Designing AI automations with n8n and Flowise, then monitoring and improving production workflows.',
        'Configuring technical architectures with Kubernetes, Docker, and GitLab CI/CD pipelines.',
        'Using monorepo architectures with Moon or Nx to structure and scale multi-project codebases.',
        'Working with Agile delivery using boards on GitLab and Gitea, with advanced team-based Git versioning practices.',
        'Integrating APIs from multiple platforms, including Google Cloud Platform, Azure, and Microsoft 365.',
        'Using Linux and Zsh daily for automation scripting, and VS Code daily for all project development.',
        'Using Google Workspace daily, especially Google Sheets with Google Apps Script for automation.',
        'Using OBS to produce training videos.',
        'Using Insomnia for API management, testing, and API documentation.',
        'Delivering advanced CSS projects in production contexts.',
      ],
      stack: [
        'Prompt Engineering',
        'AI Training',
    ...
    },
    {
      ...
      countryEmoji: '🇫🇷',
      highlights: [
        'Designed and implemented highly complex n8n workflow architectures.',
        'Integrated Microsoft 365 APIs in depth, especially Excel, Word documents, and Outlook.',
        'Built agentic flows in n8n using the Mistral API.',
        'Delivered an immersive role-play training project with AI-generated emails via Mistral and AI voice calls via ElevenLabs.',
        'Configured more than 80 role-based agents for the simulation environment.',
      ],
      stack: ['Prompt Engineering', 'Workflow Architecture', 'Agentic Systems', 'M365 API Integration'],
      techLogos: [
        'assets/images/technos/mistral.webp',
        'assets/images/technos/n8n.webp',
        'assets/images/technos/js.webp',
    ...
    },
    {
      ...
      stack: ['Frontend Development', 'Backend Development', 'Monorepo Architecture'],
      techLogos: [
    ...
    },
    {
      ...
      countryEmoji: '🇫🇷',
      highlights: [
        'Contributed to an architecture migration and developed a Nuxt.js frontend for a Hachette domain section.',
        'Implemented an OIDC (OpenID Connect) workflow in the Nuxt.js application.',
        'Built the catalog interfaces and frontend integration flows.',
        'Handled advanced API management with Gravitee and extensive Kubernetes cluster configuration.',
        'Contributed to Keycloak IAM configuration for identity and access management.',
        'Contributed to Rust backend scripts in the Axum ecosystem.',
        'Produced API documentation with OpenAPI and Insomnia, and maintained Insomnia collections for testing.',
        'Worked in team with Agile practices, Git/GitLab versioning, and GitLab CI/CD workflows.',
      ],
      stack: ['Architecture Migration', 'Identity & Access Management', 'API Lifecycle Management', 'CI/CD Delivery'],
      techLogos: [
    ...
    },
    {
      ...
      countryEmoji: '🇫🇷',
      highlights: [
        'Mixing vocals for collaborators and my own productions.',
        'Producing and composing music on FL Studio, including vocal mixing workflows.',
        'Recording pop, rap, and hip-hop vocals on Reaper in a professional studio environment.',
      ],
      stack: ['Vocal Mixing', 'Music Production', 'Music Composition', 'Studio Recording'],
      techLogos: [
    ...
    },
    {
      ...
      countryEmoji: '🌍',
      highlights: [
        'Completed an intensive web development training program.',
        'Strengthened practical skills in JavaScript, HTML, and CSS through hands-on projects.',
        'Used Git and GitHub versioning workflows across multiple projects.',
        'Delivered projects served with Node.js, including React.js frontend and Express.js backend use cases.',
        'Used Figma for UI design workflows and Insomnia for API testing.',
        'Applied SEO techniques and optimization best practices.',
      ],
      stack: ['Web Integration', 'Frontend Implementation', 'Backend Integration', 'SEO Optimization'],
      techLogos: [
        'assets/images/technos/html.webp',
        'assets/images/technos/css.webp',
        'assets/images/technos/react.webp',
        'assets/images/technos/js.webp',
        'assets/images/technos/git.webp',
    ...
    },
    {
      ...
      countryEmoji: '🇫🇷',
      highlights: [
        'Participated in a team seminar and strengthened practical JavaScript skills.',
        'Worked on data-retrieving activities with body sensors during field experiments (skiing and sledding in snow).',
        'Contributed to post-processing and structuring collected data.',
        'Versioned JavaScript code with Git and practiced Linux daily.',
      ],
      stack: ['Field Data Collection', 'Data Processing', 'Team Collaboration', 'Operational Execution'],
      techLogos: [
        'assets/images/technos/js.webp',
        'assets/images/technos/node.webp',
        'assets/images/technos/zsh.webp',
    ...
    },
    {
      ...
      countryEmoji: '🇫🇷',
      highlights: [
        'Developed Google Apps Script automations for internal company processes.',
        'Strengthened JavaScript scripting practices through automation tasks.',
        'Learned and practiced the Angular framework basics.',
        'Used and configured Linux in daily technical workflows.',
      ],
      stack: ['Process Automation', 'Internal Tooling', 'Framework Onboarding', 'Operational Support'],
      techLogos: [
        'assets/images/technos/js.webp',
        'assets/images/technos/ts.webp',
        'assets/images/technos/node.webp',
    ...
    },
    {
      ...
      highlights: [
        ...
        'Used GitLab and YAML-based configuration practices, with daily Git code versioning workflows.',
      ],
      stack: ['Technical Discovery', 'Framework Learning', 'Hardware-Software Integration', 'Versioning Discipline'],
      techLogos: [
        'assets/images/technos/rust.png',
        'assets/images/technos/angular.png',
        'assets/images/technos/ts.webp',
    ...
    },
    {
      ...
      countryEmoji: '🇫🇷',
      highlights: [
        'Set up Linux and Windows servers in LAMP and WAMP environments.',
        'Applied advanced Linux configuration and permission management.',
        'Built physical LAN infrastructures with Cisco routers and switches, including device configuration.',
        'Configured Active Directory and Entra ID (Azure).',
        'Managed ticketing workflows with GLPI.',
        'Deployed applications on Linux and Windows Server environments.',
        'Built clusters with Hyper-V and vSphere.',
        'Simulated networks with GNS3, Packet Tracer, and VMware Workstation.',
        'Delivered cybersecurity awareness activities and oral project presentations (solo and team).',
        'Strengthened IT/business English, network protocols, and OSI model fundamentals.',
        'Built and tested RJ45 network cables.',
      ],
      stack: ['Systems Administration', 'Network Engineering', 'Cybersecurity Fundamentals', 'Infrastructure Deployment'],
      techLogos: [
        'assets/images/technos/bash.webp',
        'assets/images/technos/linux.webp',
    ...
    },
    {
      ...
      stack: ['Graphic Design', 'Adobe Creative Suite', 'Video Editing'],
      techLogos: [
  ...
  trainings: TrainingItem[] = [
    {
      ...
      location: 'Marseille',
      countryEmoji: '🇫🇷',
      topics: ['Prompt Engineering', 'AI & Legal', 'AI Security', 'AI Ethics', 'Generative Image AI Content'],
      highlights: [
        'Training teams in practical Prompt Engineering for business and technical contexts.',
        'Covering AI legal topics, AI security practices, and AI ethics for responsible adoption.',
        'Teaching generative image AI workflows for content creation with production-oriented methods.',
      ],
