...
export class BubbleTasksComponent implements OnInit {
  ...
  private loadTasks(): void {
    ...
    this.bubbleGoogleSheetsService.getTasks().subscribe({
      next: (tasks) => {
        ...
        console.log('Bubble raw tasks count:', rawTasks.length);
        console.log('Bubble deduplicated tasks count:', this.tasks.length);
  ...
  toggleTask(task: Task): void {
    ...
    console.log('toggleTask - Bubble task before sync:', {
      id: task.id,
      text: task.text,
